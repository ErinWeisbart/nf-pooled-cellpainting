...
include { QC_DUP_CHECK as QC_ILLUMAPPLY_DUP_CHECK                      } from '../../../modules/local/qc/dup_check'
include { CELLPROFILER_PREPROCESS                                      } from '../../../modules/local/cellprofiler/preprocess'
include { QC_DUP_CHECK as QC_PREPROCESS_DUP_CHECK                      } from '../../../modules/local/qc/dup_check'
...
workflow BARCODING {
    ...
    ch_illumcalc_input = ch_samplesheet_sbs
        ...
        .map { meta, images_meta_list, images_list ->
            ...
            [meta, all_channels, meta.cycle, images_list, indexed_metas]
        }
